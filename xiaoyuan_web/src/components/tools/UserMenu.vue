  ...
  <div class="user-wrapper" :class="theme">
    ...
    <a-dropdown>
      ...
      <a-menu slot="overlay" class="user-dropdown-menu-wrapper">
        ...
        <a-menu-item key="2">
          <a-icon type="tool"/>
          <span @click="handleUserInfo()"> 个人信息</span>
        </a-menu-item>
    ...
    <a-modal v-model:visible="visible" title="个人信息" @ok="handleOk">
...
<script>
  ...
  export default {
    ...
    methods: {
      // updateinfo() {
      //   this.$refs.modalForm.edit(this.$store.user)
      ...
      handleOk(e) {
        ...
        getAction('/caiwu/feiyongfenxi/update', {
